...
--
-- Host: localhost:3306
-- Generation Time: Jun 07, 2025 at 05:51 PM
...
CREATE TABLE `tbl_account` (
  `Acc_SlNo` int NOT NULL,
  `Acc_Code` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Acc_Name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `Acc_Description` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `last_update_ip` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_assets` (
  ...
  `as_name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `as_sp_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `as_qty` int DEFAULT NULL,
  `as_rate` decimal(10,2) DEFAULT NULL,
  `as_amount` decimal(10,2) DEFAULT NULL,
  `buy_or_sale` enum('buy','sale') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'buy',
  `valuation` decimal(20,2) DEFAULT '0.00',
  `unit_valuation` decimal(20,2) DEFAULT '0.00',
  `as_note` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `tbl_bank_accounts` (
  ...
  `account_name` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
  `account_number` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `account_type` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `bank_name` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_name` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tbl_brand` (
  `brand_SiNo` int NOT NULL,
  `brand_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(2) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_cash_transactions` (
  `Tr_SlNo` int NOT NULL,
  `Tr_Id` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Tr_date` date NOT NULL,
  `Tr_Type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `Tr_account_Type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Acc_SlID` int NOT NULL,
  `Tr_Description` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_category` (
  `Category_SlNo` int NOT NULL,
  `Category_Name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `Category_Image` varchar(55) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Category_Icon` varchar(55) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `is_home` varchar(55) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `route` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` varchar(30) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DeletedBy` int DEFAULT NULL,
  `DeletedTime` datetime DEFAULT NULL,
  `last_update_ip` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_id` int NOT NULL
...
CREATE TABLE `tbl_cheque` (
  ...
  `SM_id` int UNSIGNED DEFAULT NULL,
  `bank_name` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `branch_name` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `check_no` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `note` text COLLATE utf8mb4_general_ci,
  `check_status` char(5) COLLATE utf8mb4_general_ci DEFAULT 'Pe' COMMENT 'Pe =Pending, Pa = Paid',
  `status` char(5) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_company` (
  ...
  `Repot_Heading` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `Company_Logo_org` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `Company_Logo_thum` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `Currency_Name` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SubCurrency_Name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Currency_Symbol` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `InvoiceHeder` varchar(100) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Sales Invoice',
  `InvoiceNote` text COLLATE utf8mb4_general_ci,
  `print_type` int NOT NULL,
  `dueStatus` varchar(5) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'true',
...
CREATE TABLE `tbl_country` (
  `Country_SlNo` int NOT NULL,
  `CountryName` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int NOT NULL,
...
CREATE TABLE `tbl_customer` (
  ...
  `Customer_Type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Customer_Phone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Customer_Mobile` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `Customer_Email` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Customer_OfficePhone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Customer_Address` varchar(300) COLLATE utf8mb4_general_ci NOT NULL,
  `owner_name` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Country_SlNo` int NOT NULL,
  `district_id` int DEFAULT NULL,
  `thana_id` int DEFAULT NULL,
  `Customer_Web` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Cust_Pass` varchar(55) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_customer_payment` (
  ...
  `CPayment_invoice` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CPayment_customerID` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CPayment_TransactionType` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CPayment_amount` decimal(18,2) DEFAULT NULL,
  `out_amount` float NOT NULL DEFAULT '0',
  `CPayment_Paymentby` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_id` int DEFAULT NULL,
  `CPayment_previous_due` float NOT NULL DEFAULT '0',
  `CPayment_notes` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` varchar(1) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_damage` (
  `Damage_SlNo` int NOT NULL,
  `Damage_InvoiceNo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Damage_Date` date NOT NULL,
  `damage_amount` decimal(18,2) NOT NULL DEFAULT '0.00',
  `Damage_Description` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_damage_details` (
  `DamageDetails_SlNo` int NOT NULL,
  `Damage_SlNo` int NOT NULL,
...
CREATE TABLE `tbl_district` (
  `District_SlNo` int NOT NULL,
  `District_Name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_employee` (
  `Employee_SlNo` int NOT NULL,
  `Designation_ID` int NOT NULL,
  `Department_ID` int NOT NULL,
  `Employee_ID` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `bio_id` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Employee_Name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_JoinDate` date NOT NULL,
  `Employee_Gender` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_BirthDate` date NOT NULL,
  `Employee_NID` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_ContactNo` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_Email` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_MaritalStatus` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_FatherName` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_MotherName` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_PrasentAddress` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_PermanentAddress` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_Pic_org` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `Employee_Pic_thum` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `salary_range` int NOT NULL,
  `Employee_Reference` mediumtext COLLATE utf8mb4_general_ci,
  `status` char(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_employee_payment` (
  ...
  `status` char(2) COLLATE utf8mb4_general_ci DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_employee_payment_details` (
  ...
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int UNSIGNED DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_expense_head` (
  `id` int NOT NULL,
  `head_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('a','d') COLLATE utf8mb4_general_ci DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_investment_account` (
  `Acc_SlNo` int NOT NULL,
  `Acc_Code` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Acc_Tr_Type` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Acc_Name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `Acc_Type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Acc_Description` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_loan_transactions` (
  ...
  `account_id` int NOT NULL,
  `transaction_date` date NOT NULL,
  `transaction_type` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `amount` float NOT NULL,
  `note` text COLLATE utf8mb4_general_ci,
  `status` int NOT NULL DEFAULT '1',
  `AddBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_month` (
  `month_id` int NOT NULL,
  `month_name` char(30) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_outlet` (
  `branch_id` int NOT NULL,
  `Branch_name` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `Branch_title` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `Branch_phone` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `Branch_address` mediumtext COLLATE utf8mb4_general_ci NOT NULL,
  `Branch_sales` varchar(1) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'Wholesales = 1, Retail = 2',
...
CREATE TABLE `tbl_product` (
  ...
  `slug` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `ProductCategory_ID` int NOT NULL,
  `ProductSubCategory_ID` int NOT NULL,
  `Color_ID` int NOT NULL,
  `Brand_ID` int NOT NULL,
  `Unit_ID` int NOT NULL,
  `size` varchar(11) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'na',
  `vat` float NOT NULL,
  `Product_ReOrederLevel` int NOT NULL,
  ...
  `one_cartun_equal` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `short_description` mediumtext COLLATE utf8mb4_general_ci,
  `Product_Description` longtext COLLATE utf8mb4_general_ci,
  `is_website` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'true',
  `is_service` varchar(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `is_featured` varchar(9) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `is_offer` varchar(9) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `is_arrival` varchar(9) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `is_popular` varchar(9) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `Video_Url` text COLLATE utf8mb4_general_ci,
  `Product_Image` varchar(55) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Product_SizeImage` varchar(55) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
(141, 'P00141', 'Testing Pro Products', 'testing-pro-products-680bcc9c67bc5', 18, 1, 1, 1, 1, 'na', 0, 10, 10000.00, 1200.00, 0.00, 0.00, 1500.00, '', NULL, '<h2>Test</h2><ul><li>Test</li><li>Tes</li><li>Test</li></ul>', 'true', 'false', 'false', 'true', 'false', 'false', 'https://www.youtube.com/embed/L2KI8lpS1SY', 'uploads/products/796558_67b0d6e2347d4.jpg', 'uploads/products/sizes/410843_680bbcf126441.png', 'a', 1, '2024-11-12 13:36:32', 1, '2025-05-10 00:01:08', NULL, NULL, '::1', 1);
...
CREATE TABLE `tbl_product_gallery` (
  ...
  `Gallery_Image` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(10) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_purchase_details` (
  `PurchaseDetails_SlNo` int NOT NULL,
  `PurchaseMaster_IDNo` int NOT NULL,
  `Product_IDNo` int NOT NULL,
...
CREATE TABLE `tbl_purchase_master` (
  `PurchaseMaster_SlNo` int NOT NULL,
  `Supplier_SlNo` int DEFAULT NULL,
  `supplierType` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `supplierName` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `supplierMobile` varchar(15) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `supplierAddress` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Employee_SlNo` int NOT NULL,
  `PurchaseMaster_InvoiceNo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `PurchaseMaster_OrderDate` date NOT NULL,
  `PurchaseMaster_PurchaseFor` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `PurchaseMaster_Description` longtext COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_purchase_return` (
  `PurchaseReturn_SlNo` int NOT NULL,
  `PurchaseMaster_InvoiceNo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Supplier_IDdNo` int DEFAULT NULL,
  `PurchaseReturn_ReturnDate` date NOT NULL,
  `PurchaseReturn_ReturnAmount` decimal(18,2) NOT NULL,
  `PurchaseReturn_Description` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_purchase_return_details` (
  `PurchaseReturnDetails_SlNo` int NOT NULL,
  `PurchaseReturn_SlNo` int NOT NULL,
  `PurchaseReturnDetailsProduct_SlNo` int NOT NULL,
...
CREATE TABLE `tbl_quotation_details` (
  `SaleDetails_SlNo` int NOT NULL,
  `SaleMaster_IDNo` int NOT NULL,
  `Product_IDNo` int NOT NULL,
...
CREATE TABLE `tbl_quotation_master` (
  ...
  `SaleMaster_customer_address` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SaleMaster_SaleDate` date NOT NULL,
  `SaleMaster_Description` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `tbl_sale_details` (
  ...
  `SaleDetails_Tax` decimal(18,2) NOT NULL,
  `SaleDetails_TotalAmount` decimal(18,2) NOT NULL,
  `is_service` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_sale_master` (
  ...
  `customerAddress` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `employee_id` int DEFAULT NULL,
  `SaleMaster_SaleDate` date NOT NULL,
  `SaleMaster_Description` text COLLATE utf8mb4_general_ci,
  `SaleMaster_SaleType` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tbl_sale_return` (
  `SaleReturn_SlNo` int NOT NULL,
  `SaleMaster_InvoiceNo` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `SaleReturn_ReturnDate` date NOT NULL,
  `SaleReturn_ReturnAmount` decimal(18,2) NOT NULL,
  `SaleReturn_Description` varchar(300) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_sale_return_details` (
  `SaleReturnDetails_SlNo` int NOT NULL,
  `SaleReturn_IdNo` int NOT NULL,
  `SaleReturnDetailsProduct_SlNo` int NOT NULL,
...
CREATE TABLE `tbl_sms` (
  ...
  `sms_text` varchar(500) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_sms_settings` (
  `sms_enabled` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'false',
  `api_key` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sms_type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `url` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `bulk_url` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_2` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `bulk_url_2` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sender_id` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sender_id_2` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `sender_name` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `sender_phone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_sub_category` (
  `SubCategory_SlNo` int NOT NULL,
  `Category_SlNo` int NOT NULL,
  `SubCategory_Name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `route` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
...
CREATE TABLE `tbl_supplier` (
  ...
  `Supplier_Type` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'retail',
  `Supplier_Phone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Supplier_Mobile` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `Supplier_Email` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `Supplier_OfficePhone` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `District_SlNo` int NOT NULL,
  `Supplier_Web` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `previous_due` decimal(18,2) NOT NULL,
  `image_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `AddBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_supplier_payment` (
  `SPayment_id` int NOT NULL,
  `SPayment_date` date DEFAULT NULL,
  `SPayment_invoice` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SPayment_customerID` int DEFAULT NULL,
  `SPayment_TransactionType` varchar(25) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `SPayment_amount` decimal(18,2) DEFAULT NULL,
  `SPayment_Paymentby` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `account_id` int DEFAULT NULL,
  `SPayment_notes` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` varchar(1) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Addby` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_thana` (
  `Thana_SlNo` int NOT NULL,
  `District_SlNo` int NOT NULL,
  `Thana_Name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int DEFAULT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
  `UpdateTime` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DeletedBy` int DEFAULT NULL,
  `DeletedTime` datetime DEFAULT NULL,
  `last_update_ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `branch_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_transfer_details` (
  `transferdetails_id` int NOT NULL,
...
CREATE TABLE `tbl_transfer_master` (
  ...
  `DeletedBy` int DEFAULT NULL,
  `DeletedTime` datetime DEFAULT NULL,
  `last_update_ip` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_unit` (
  `Unit_SlNo` int NOT NULL,
  `Unit_Name` varchar(150) COLLATE utf8mb4_general_ci NOT NULL,
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL,
  `AddBy` int NOT NULL,
  `AddTime` datetime DEFAULT NULL,
  `UpdateBy` int DEFAULT NULL,
...
CREATE TABLE `tbl_user_activity` (
  ...
  `status` char(2) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'a',
  `branch_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_website_profile` (
  `Website_SlNo` int NOT NULL,
  `Website_Name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `Website_Mobile` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `Website_Email` varchar(250) COLLATE utf8mb4_general_ci NOT NULL,
  `Software_Url` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Website_Address` text COLLATE utf8mb4_general_ci,
  `Opening_Day` varchar(250) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `isd_charge` decimal(18,2) NOT NULL DEFAULT '0.00',
  `osd_charge` decimal(18,2) NOT NULL DEFAULT '0.00',
  `Website_TagLine` text COLLATE utf8mb4_general_ci,
  `Short_Details` text COLLATE utf8mb4_general_ci NOT NULL,
  `Facebook_Url` text COLLATE utf8mb4_general_ci,
  `Instragram_Url` text COLLATE utf8mb4_general_ci,
  `Youtube_Url` text COLLATE utf8mb4_general_ci,
  `Header_Logo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Footer_Logo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Mobile_Logo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Fav_Logo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Developed_By` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `Developer_Url` text COLLATE utf8mb4_general_ci,
  `UpdateBy` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `UpdateTime` datetime DEFAULT NULL,
  `last_update_ip` varchar(45) COLLATE utf8mb4_general_ci NOT NULL,
  `branch_id` int NOT NULL
...
(1, 'SopnoJhuri', '01515674721', 'sopnojhuribd@gmail.com', 'http://localhost:85/', 'Mirpur-10, Dhaka', 'Saturday – Friday: 9AM to 10PM', 60.00, 120.00, 'Shop. Smile. Repeat.', 'SopnoJhuri – Explore a wide range of quality products, from essentials to unique finds, all in one place. Shop now and bring your dreams to life!', 'https://www.facebook.com/sopnojhuribd/', 'https://www.instagram.com/sopnojhuri/', 'https://www.youtube.com/@sopnojhuri', 'uploads/websites/772408_67b8afc6762c8.png', 'uploads/websites/570339_67b8afc676726.png', 'uploads/websites/994244_67b04e0416fbb.png', 'uploads/websites/808868_67b04e0418562.png', 'FARABiE IT', 'https://www.mlalonhossain.com', '1', '2025-05-16 22:34:10', '::1', 1);
...
--
ALTER TABLE `tbl_account`
  MODIFY `Acc_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `tbl_assets`
--
ALTER TABLE `tbl_assets`
  MODIFY `as_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_brand`
  MODIFY `brand_SiNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `tbl_cash_transactions`
--
ALTER TABLE `tbl_cash_transactions`
  MODIFY `Tr_SlNo` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_category`
--
ALTER TABLE `tbl_category`
  MODIFY `Category_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `tbl_color`
  MODIFY `color_SiNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `tbl_company`
--
ALTER TABLE `tbl_company`
  MODIFY `Company_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_country`
--
ALTER TABLE `tbl_country`
  MODIFY `Country_SlNo` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_customer`
--
ALTER TABLE `tbl_customer`
  MODIFY `Customer_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `tbl_customer_payment`
--
ALTER TABLE `tbl_customer_payment`
  MODIFY `CPayment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `tbl_damage`
--
ALTER TABLE `tbl_damage`
  MODIFY `Damage_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_damage_details`
--
ALTER TABLE `tbl_damage_details`
  MODIFY `DamageDetails_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_department`
--
ALTER TABLE `tbl_department`
  MODIFY `Department_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_designation`
--
ALTER TABLE `tbl_designation`
  MODIFY `Designation_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_district`
--
ALTER TABLE `tbl_district`
  MODIFY `District_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_employee`
--
ALTER TABLE `tbl_employee`
  MODIFY `Employee_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_investment_account`
  MODIFY `Acc_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_month`
  MODIFY `month_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_product`
  MODIFY `Product_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=142;

--
-- AUTO_INCREMENT for table `tbl_product_gallery`
--
ALTER TABLE `tbl_product_gallery`
  MODIFY `Gallery_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `tbl_product_inventory`
--
ALTER TABLE `tbl_product_inventory`
  MODIFY `inventory_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;

--
-- AUTO_INCREMENT for table `tbl_purchase_details`
--
ALTER TABLE `tbl_purchase_details`
  MODIFY `PurchaseDetails_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;

--
-- AUTO_INCREMENT for table `tbl_purchase_master`
--
ALTER TABLE `tbl_purchase_master`
  MODIFY `PurchaseMaster_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;

--
-- AUTO_INCREMENT for table `tbl_purchase_return`
--
ALTER TABLE `tbl_purchase_return`
  MODIFY `PurchaseReturn_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_purchase_return_details`
--
ALTER TABLE `tbl_purchase_return_details`
  MODIFY `PurchaseReturnDetails_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_quotation_details`
--
ALTER TABLE `tbl_quotation_details`
  MODIFY `SaleDetails_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `tbl_quotation_master`
--
ALTER TABLE `tbl_quotation_master`
  MODIFY `SaleMaster_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `tbl_sale_details`
--
ALTER TABLE `tbl_sale_details`
  MODIFY `SaleDetails_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=419;

--
-- AUTO_INCREMENT for table `tbl_sale_master`
--
ALTER TABLE `tbl_sale_master`
  MODIFY `SaleMaster_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=288;

--
-- AUTO_INCREMENT for table `tbl_sale_return`
--
ALTER TABLE `tbl_sale_return`
  MODIFY `SaleReturn_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `tbl_sale_return_details`
--
ALTER TABLE `tbl_sale_return_details`
  MODIFY `SaleReturnDetails_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `tbl_sms`
--
ALTER TABLE `tbl_sms`
  MODIFY `row_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `tbl_sub_category`
--
ALTER TABLE `tbl_sub_category`
  MODIFY `SubCategory_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;

--
-- AUTO_INCREMENT for table `tbl_supplier`
--
ALTER TABLE `tbl_supplier`
  MODIFY `Supplier_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `tbl_supplier_payment`
--
ALTER TABLE `tbl_supplier_payment`
  MODIFY `SPayment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `tbl_thana`
--
ALTER TABLE `tbl_thana`
  MODIFY `Thana_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;

--
-- AUTO_INCREMENT for table `tbl_transfer_details`
--
ALTER TABLE `tbl_transfer_details`
  MODIFY `transferdetails_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_transfer_master`
--
ALTER TABLE `tbl_transfer_master`
  MODIFY `transfer_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_unit`
--
ALTER TABLE `tbl_unit`
  MODIFY `Unit_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tbl_user`
--
ALTER TABLE `tbl_user`
  MODIFY `User_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `tbl_user_access`
--
ALTER TABLE `tbl_user_access`
  MODIFY `access_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tbl_website_profile`
  MODIFY `Website_SlNo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
